...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<TubeP_EQProcessor>(m_sr); }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<ConsoleE_EQProcessor>(m_sr); }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<VintageG_EQProcessor>(m_sr); }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<Graphic10_EQProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<AirLift_EQProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { 
        auto p = std::make_unique<Opto2AProcessor>(m_meterSource); 
        m_lastProc = p.get();
        return p; 
    }
...
public:
    ...
    std::vector<Port> getInputPorts() const override { return { {"Input", 2}, {"Sidechain", 2, Port::Sidechain} }; }
    std::unique_ptr<FluxProcessor> createProcessor() override { 
        auto p = std::make_unique<FET76Processor>(m_meterSource);
        m_lastProc = p.get();
        return p;
    }
    float getLatestGR() const { return m_lastProc ? m_lastProc->getGR() : 0.0f; }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { 
        auto p = std::make_unique<VCABusProcessor>(m_meterSource);
        m_lastProc = p.get();
        return p;
    }
    float getLatestGR() const { return m_lastProc ? m_lastProc->getGR() : 0.0f; }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { 
        auto p = std::make_unique<VariMuProcessor>(m_meterSource);
        m_lastProc = p.get();
        return p;
    }
    float getLatestGR() const { return m_lastProc ? m_lastProc->getGR() : 0.0f; }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<SteelPlateProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<GoldenHallProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<CopperSpringProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<CathedralProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<GrainVerbProcessor>(); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<EchoPlexProcessor>(m_sr); }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<BBD_BucketProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<Reverse_DelayProcessor>(m_sr); }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<PingPong_DelayProcessor>(m_sr); }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<SpaceShiftProcessor>(); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { 
        auto p = std::make_unique<TubeLimiterProcessor>(m_meterSource);
        m_lastProc = p.get();
        return p;
    }
    float getLatestGR() const { return m_lastProc ? m_lastProc->getGR() : 0.0f; }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { 
        auto p = std::make_unique<FluxSpectrumProcessor>(m_sr);
        m_lastProc = p.get();
        return p;
    }
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { 
        auto p = std::make_unique<FluxLoudnessProcessor>();
        m_lastProc = p.get();
        return p; 
    }
    void updateVisuals() {
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<SaturationProcessor>(); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
...
public:
    ...
    std::unique_ptr<FluxProcessor> createProcessor() override { return std::make_unique<LookaheadLimiterProcessor>(m_sr); }
    std::shared_ptr<Component> createEditor(const NodeEditorContext&) override { 
