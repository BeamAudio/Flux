 ...
 */
class VST3HostNode : public FluxNode, public Steinberg::Vst::IHostApplication {
public:
    ...
    Steinberg::uint32 PLUGIN_API release() override { return 1; } // This name is used by VST3
