...
\item 
void \doxymbox{\hyperlink{class_beam_1_1_input_handler_a13cc6aa32a46b209a89f12db76236200}{handle\+Mouse\+Wheel}} (float x, float y, float delta)
\item 
void \doxymbox{\hyperlink{class_beam_1_1_input_handler_acd93a9973f465ad5a6d9f0ccdc72636a}{update}} (float dt)
\item 
void \doxymbox{\hyperlink{class_beam_1_1_input_handler_a59aa6d328f5c20ab523d5201302007b0}{render}} (\doxymbox{\hyperlink{class_beam_1_1_quad_batcher}{Quad\+Batcher}} \&batcher, float dt, float screenW, float screenH)
...
\Hypertarget{class_beam_1_1_input_handler_a13cc6aa32a46b209a89f12db76236200}\index{Beam::InputHandler@{Beam::InputHandler}!handleMouseWheel@{handleMouseWheel}}
\index{handleMouseWheel@{handleMouseWheel}!Beam::InputHandler@{Beam::InputHandler}}
\doxysubsubsection{\texorpdfstring{handleMouseWheel()}{handleMouseWheel()}}
{\footnotesize\ttfamily \label{class_beam_1_1_input_handler_a13cc6aa32a46b209a89f12db76236200} 
void Beam::\+\+Input\+Handler::\+handle\+Mouse\+Wheel (\begin{DoxyParamCaption}\item[{float}]{x}{, }\item[{float}]{y}{, }\item[{float}]{delta}{}\end{DoxyParamCaption})}

\Hypertarget{class_beam_1_1_input_handler_a59aa6d328f5c20ab523d5201302007b0}\index{Beam::InputHandler@{Beam::InputHandler}!render@{render}}
\index{render@{render}!Beam::InputHandler@{Beam::InputHandler}}
\doxysubsubsection{\texorpdfstring{render()}{render()}}
{\footnotesize\ttfamily \label{class_beam_1_1_input_handler_a59aa6d328f5c20ab523d5201302007b0} 
void Beam::\+\+Input\+Handler::\+render (\begin{DoxyParamCaption}\item[{\doxymbox{\hyperlink{class_beam_1_1_quad_batcher}{Quad\+Batcher}} \&}]{batcher}{, }\item[{float}]{dt}{, }\item[{float}]{screenW}{, }\item[{float}]{screenH}{}\end{DoxyParamCaption})}
...
\item 
src/\+interface/\+\doxymbox{\hyperlink{input__handler_8hpp}{input\+\_\+handler.\+hpp}}\item 
src/\+interface/\+\doxymbox{\hyperlink{input__handler_8cpp}{input\+\_\+handler.\+cpp}}\end{DoxyCompactItemize}
