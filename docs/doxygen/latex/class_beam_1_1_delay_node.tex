...
\item 
void \doxymbox{\hyperlink{class_beam_1_1_delay_node_a1f946e80326aaaf6dc87e6ec4e4b1858}{process}} (float \texorpdfstring{$\ast$}{*}buffer, int frames, int channels) override
\item 
...
\Hypertarget{class_beam_1_1_delay_node_a1f946e80326aaaf6dc87e6ec4e4b1858}\index{Beam::DelayNode@{Beam::DelayNode}!process@{process}}
\index{process@{process}!Beam::DelayNode@{Beam::DelayNode}}
\doxysubsubsection{\texorpdfstring{process()}{process()}}
{\footnotesize\ttfamily \label{class_beam_1_1_delay_node_a1f946e80326aaaf6dc87e6ec4e4b1858} 
void Beam::\+\+Delay\+Node::\+process (\begin{DoxyParamCaption}\item[{float \texorpdfstring{$\ast$}{*}}]{buffer}{, }\item[{int}]{frames}{, }\item[{int}]{channels}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [override]}, {\ttfamily [virtual]}}
...
\item 
src/\+dsp/\+\doxymbox{\hyperlink{delay__node_8hpp}{delay\+\_\+node.\+hpp}}\end{DoxyCompactItemize}
